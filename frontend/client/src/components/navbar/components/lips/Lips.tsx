...
const Lips = () => {
  ...
  return (
    <div className="w-full space-y-4">
      <div className="p-4 xl:p-0 grid sm:grid-cols-2 md:grid-cols-3 md:gap-4 lg:grid-cols-4 grid-rows-1 lg:gap-6 justify-center w-full">
          ...
          >
            ...
            <div className="flex flex-col gap-1 md:gap-2 lg:gap-3">
              {category.subCategories.map((subCategory, index) => {
                const isSerum = subCategory.label === "Hi-Shine Lipsticks";
      ...
      <hr className="hidden lg:block border border-primary-50" />
      <div className="w-full hidden lg:block">
        <div className="flex items-center gap-1">
          <MessageIcon className="w-5 h-5 fill-secondary" />
          <p className="text-sm font-normal leading-[21px] text-secondary">
            Customer's Feedback:
          </p>
        </div>
        <div className="text-tertiary text-xs mt-2">
          Great variety of lipsticks! Loved the shades and textures.
          Long-lasting and comfortable. Perfect for every occasion. Highly
          recommended! Great variety of lipsticks! Loved the shades and
          textures. Long-lasting and comfortable. Perfect for every occasion.
          Highly recommended!
        </div>
      </div>
    </div>
