      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center gap-4 border border-[red]">
        <div className="w-full">
          <div className="text-center">
            <div className="w-20 h-20 mx-auto rounded-full relative shadow-2xl shadow-black overflow-hidden cursor-pointer group">
              <div className="absolute inset-0 bg-gradient-to-br from-primary via-transparent to-gray-400 rounded-full blur-sm animate-pulse" />
              <img
                ...
                alt="Profile Picture"
                className="object-cover bg-accent-duo rounded-full w-full h-full shadow-inner border border-smoke-eerie"
              />
